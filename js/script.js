...
window.addEventListener("load", function() {
  ...
  function calendarBuilder() {
    var date = new Date(),
      leap_year =
        date.getMonth() === 1 && date.getFullYear() % 4 === 0 ? 29 : 28,
      months = [
        "January",
        "February",
        "March",
    ...
    while (j <= daysInMonths[currentMonth]) {
      ...
      for (var i = 0; i < 7; i++) {
        ...
        weekArray.push(
          buildDateSpan(j > 0 && j <= daysInMonths[currentMonth] ? j : "")
        );
        j++;
      }
  ...
  function calendarHider() {
    document.getElementsByClassName("calendar_front_page2")[0].style.display =
      "none";
  }

  function listenHider() {
    document.getElementsByClassName("listen_front_page2")[0].style.display =
      "none";
  }

  function lessonsHider() {
    document.getElementsByClassName("lessons_front_page2")[0].style.display =
      "none";
  }
